import subprocess, sys, os, asyncio, re, shutil, random, math, time
import hashlib
...
GITHUB_REPO = "jmkfivm/auto_accounting"  # your public or private repo
LOCAL_VERSION = "1.0.0"         # store this in your app
...
def auto_update():
    ...
    if latest and latest != LOCAL_VERSION:
        ...
        subprocess.run(["uv", "pip", "install", "-U", "-r", "requirements.txt"], check=False)
